    ...
    <div id="about" className="px-8 my-6 lg:my-20 flex flex-col gap-10 xs:px-10 lg:px-14 xl:px-20 2xl:px-40 3xl:px-60 lg:gap-24">
      <div className="flex flex-col gap-5 lg:flex-row-reverse lg:gap-10 2xl:gap-20">
        ...
        <article className="prose lg:prose-xl prose-gray max-w-full lg:basis-[70%] 2xl:basis-[70%]">
          ...
          <p>Outside of work, I enjoy spending time with my family and reading, which helps me bring fresh perspectives to problem-solving and creativity. Additionally, I run a YouTube channel, <a href="https://www.youtube.com/@DevDreamer" target="_blank" className="bg-red-50 text-[#dd0031] font-semibold">Dev Dreamer</a>, where I share tutorials on HTML, CSS, and JavaScript to help others grow in their development journey.</p>
